...
typedef struct icdfagen {
  ...
  mpz_t *grid;
  unsigned int rndst;  /* state to make system tandom generator statefull */
} *icdfagen_t;
...
extern icdfagen_t icdfaGenInit(int nstates, int nsymbols, int ac_only, int ibias, int random, unsigned long seed);
